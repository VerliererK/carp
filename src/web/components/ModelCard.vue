...
<template>
  <div
    ...
    <div
      ...
      <div class="flex items-center gap-1.5" title="Mappings">
        <Icon icon="lucide:route" class="w-3.5 h-3.5 md:w-4 md:h-4 text-text-tertiary" />
        <span class="font-mono text-sm font-semibold text-text-secondary">{{ model.mappings_count }}</span>
      </div>
